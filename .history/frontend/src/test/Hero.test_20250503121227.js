...
describe('Hero Component',()=>{
    ...
    test('renders signup button',()=>{ 
        render(<Hero/>); //load Hero component
        const signupButton = screen.getByRole('button',{"/signup now/i"}); 
        expect(signupButton).toBeInTheDocument(); 
        expect(signupButton).toHaveAttribute('src','media/images/homeHero.png'); // the source of the image should match with the given src
    })
})
