  ...
  return (
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/sensibullLogo.svg" mt-2 style={{ width: "180px", height: "auto"}} />
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/goldenpiLogo.png" style={{ width: "180px", height: "auto" }} />
          <p className="text-small text-muted mt-2">Bonds trading platform</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img src="media/images/dittoLogo.png" style={{ width: "140px", height: "auto" }}  />
